...
if( !(preg_match('/^DWDM[0-9][0-9][0-9][0-9][0-9][0-9]$/', $circuit['cid']) ) )
...
if($circuit['capacity'] == "")                                                                                                  { $Result->show("danger", _('Capacity is mandatory').'!', true); }

# Customer must be present
if($circuit['customer_id'] == "0")                                                                                                  { $Result->show("danger", _('Customer is mandatory').'!', true); }

# Location Point A must be present
if($circuit['device1'] == "0")                                                                                                  { $Result->show("danger", _('Location Point A is mandatory').'!', true); }

# Location Point B must be present
if($circuit['device2'] == "0")                                                                                                  { $Result->show("danger", _('Location Point B is mandatory').'!', true); }
...
if( !(($circuit['dwdmchannel'] >= 21) && ($circuit['dwdmchannel']) <=60  && is_numeric($circuit['dwdmchannel']) ) )
