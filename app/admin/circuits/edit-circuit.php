...
<div class="pContent">
	...
	<tr>
		...
		<td>
			<input readonly='readonly' type="text" id='circuitid' name="cid" style='width:200px;' class="form-control input-sm" placeholder="<?php print _('ID'); ?>" value="<?php if(isset($circuit->cid)) print $circuit->cid; ?>" <?php print $readonly; ?>>
			<?php
			if( ($POST->action == "edit") || ($POST->action == "delete") ) {
			...
			<input type="hidden" name="csrf_cookie" value="<?php print $csrf; ?>">
      			<input type='button' value='RandomCID' class='button' onclick="javascript:randomCircuit('circuitid',9,<?php echo "'".$configValues['CONFIG_USER_ALLOWEDRANDOMCHARS']."'" ?>)" />
      			<input type='button' value='RandomDWDM' class='button' onclick="javascript:randomCircuitDWDM('circuitid',9,<?php echo "'".$configValues['CONFIG_USER_ALLOWEDRANDOMCHARS']."'" ?>)" />
      			<input type='button' value='RandomDF' class='button' onclick="javascript:randomCircuitDarkFiber('circuitid',9,<?php echo "'".$configValues['CONFIG_USER_ALLOWEDRANDOMCHARS']."'" ?>)" />
