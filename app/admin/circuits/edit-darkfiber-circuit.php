...
<div class="pContent">
	...
	<tr>
		...
		<td>
			...
			<input type="hidden" name="csrf_cookie" value="<?php print $csrf; ?>">
                        	<input type='button' value='Random' class='button' onclick="javascript:randomCircuitDarkFiber('circuitid',6,<?php echo " '".$configValues['CONFIG_USER_ALLOWEDRANDOMCHARS']."' " ?>)" />
		</td>
	</tr>
	...
	<tr hidden>
		...
		<td>
			<input type="text" name="ctype" style='width:200px;'  class="form-control input-sm" value="darkfiber" <?php print $readonly; ?>>
		</td>
	</tr>
...
<div class="pFooter">
	<div class="btn-group">
		...
		<button class="btn btn-sm btn-default submit_popup <?php if($_POST['action']=="delete") { print "btn-danger"; } else { print "btn-success"; } ?>" data-script="app/admin/circuits/edit-darkfiber-circuit-submit.php" data-result_div="circuitManagementEditResult" data-form='circuitManagementEdit'>
