...
<div class="pContent">
	...
	<tr>
		...
		<td>
			<input  id='circuitid' type="text" name="cid" style='width:200px;' class="form-control input-sm" placeholder="<?php print _('ID'); ?>" value="<?php if(isset($circuit->cid)) print $Tools->strip_xss($circuit->cid); ?>" <?php print $readonly; ?>>
			<?php
			if( ($_POST['action'] == "edit") || ($_POST['action'] == "delete") ) {
  ...
  <!-- ctype -->
	<tr hidden>
		...
		<td>
			<input type="text" name="ctype" style='width:200px;'  class="form-control input-sm" value="network" <?php print $readonly; ?>>
		</td>
	</tr>
	...
	<tr>
		<td>
    		...
    		<td>
    			<input type="text" name="cvlandevice1" style='width:200px;'  class="form-control input-sm" placeholder="<?php print _('C-Vlan Point A'); ?>" value="<?php if(isset($circuit->scvlandevice1)) print $Tools->strip_xss($circuit->cvlandevice1); ?>" <?php print $readonly; ?>>
		</td>
	</tr>
	...
	<tr>
      ...
      <tr>
    		<td><?php print _('Interface Point B'); ?></td>
    		<td>
	...
	<tr>
    	...
    	<tr>
    		<td><?php print _('DWDM Channel'); ?></td>
    		<td>
    			<input type="text" name="dwdmchannel" style='width:200px;' class="form-control input-sm" placeholder="<?php print _('DWDM Channel'); ?>" value="<?php if(isset($circuit->dwdmchannel)) print $Tools->strip_xss($circuit->dwdmchannel); ?>" <?php print $readonly; ?>>
    		</td>
    	</tr>
	<tr>
		<td><?php print _('Address A'); ?></td>
		<td>
			<input type="text" name="address1" class="form-control input-sm" placeholder="<?php print _('Address A'); ?>" value="<?php if(isset($circuit->address1)) print $Tools->strip_xss($circuit->address1); ?>" <?php print $readonly; ?>>
		</td>
	</tr>
	<tr>
		<td><?php print _('Address B'); ?></td>
		<td>
			<input type="text" name="address2" class="form-control input-sm" placeholder="<?php print _('Address B'); ?>" value="<?php if(isset($circuit->address2)) print $Tools->strip_xss($circuit->address2); ?>" <?php print $readonly; ?>>
		</td>
	</tr>
...
<div class="pFooter">
	<div class="btn-group">
		...
		<button class="btn btn-sm btn-default submit_popup <?php if($_POST['action']=="delete") { print "btn-danger"; } else { print "btn-success"; } ?>" data-script="app/admin/circuits/edit-network-circuit-submit.php" data-result_div="circuitManagementEditResult" data-form='circuitManagementEdit'>
