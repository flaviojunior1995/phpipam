...
$circuits = $Tools->fetch_all_circuits_customer($custom_fields);
...
# title
print "<h4>"._('List of customers circuits')."</h4>";
print "<hr>";
...
print "<div class='btn-group'>";
    ...
    print "<a href='' class='btn btn-sm btn-default open_popup' data-script='app/admin/circuits/edit-customer-circuit.php' data-class='700' data-action='add' data-circuitid='' style='margin-bottom:10px;'><i class='fa fa-plus'></i> "._('Add circuit')."</a>";
	}
print "</div>";
...
// result
	...
	foreach ($circuits as $circuit) {
        ...
        if($User->get_module_permissions ("circuits")>=User::ACCESS_RW) {
            ...
            $links[] = ["type"=>"link", "text"=>_("Edit circuit"), "href"=>"", "class"=>"open_popup", "dataparams"=>" data-script='app/admin/circuits/edit-customer-circuit.php' data-class='700' data-action='edit' data-circuitid='$circuit->id'", "icon"=>"pencil"];
        }
        if($User->get_module_permissions ("circuits")>=User::ACCESS_RW) {
            $links[] = ["type"=>"link", "text"=>_("Delete circuit"), "href"=>"", "class"=>"open_popup", "dataparams"=>"  data-script='app/admin/circuits/edit-customer-circuit.php' data-class='700' data-action='delete' data-circuitid='$circuit->id'", "icon"=>"times"];
        }
        // print links
