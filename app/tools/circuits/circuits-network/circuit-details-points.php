...
print "<table class='table table-condensed table-top'>";
	...
	// device interface
	print "<tr>";
	print "	<td><strong>"._('Interface Device')."</strong></td>";
	print "	<td>$circuit->intdevice1</td>";
	print "	<td>$circuit->intdevice2</td>";
	print "</tr>";

	// device svlan
	print "<tr>";
	print " <td><strong>"._('S-Vlan Device')."</strong></td>";
	print " <td>$circuit->svlandevice1</td>";
	print " <td>$circuit->svlandevice2</td>";
	print "</tr>";

	// device cvlan
	print "<tr>";
	print "	<td><strong>"._('C-Vlan Device')."</strong></td>";
	print "	<td>$circuit->cvlandevice1</td>";
	print "	<td>$circuit->cvlandevice2</td>";
	print "</tr>";
	...
	// Address1
	print "<tr>";
	print "	<td><strong>"._('Address')."</strong></td>";
	print "	<td>$circuit->address1</td>";
	print "	<td>$circuit->address2</td>";
	print "</tr>";
