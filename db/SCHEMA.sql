...
CREATE TABLE `circuits` (
  ...
  `ctype` enum('network','customer','dwdm') DEFAULT NULL,
  ...
  `intdevice1` varchar(60) DEFAULT NULL,
  `svlandevice1` int(4) unsigned DEFAULT NULL,
  `cvlandevice1` int(4) unsigned DEFAULT NULL,
  `device2` int(11) unsigned DEFAULT NULL,
  `location2` int(11) unsigned DEFAULT NULL,
  `intdevice2` varchar(60) DEFAULT NULL,
  `svlandevice2` int(4) unsigned DEFAULT NULL,
  `cvlandevice2` int(4) unsigned DEFAULT NULL,
  `pwid` int(10) unsigned  DEFAULT NULL,
  `route_distinguisher` varchar(16) DEFAULT NULL,
  `dwdmchannel` int(2) unsigned  DEFAULT NULL,
  `address1` text,
  `address2` text,
  `partner` enum('yes','no') DEFAULT NULL,
  `partner_info` text,
  `comment` text,
